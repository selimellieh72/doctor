    ...
    <main>
      ...
      <section className="services my-16 space-y-16 px-4 text-secondary lg:px-16">
        <div class=" mx-auto flex flex-col justify-center">
          <h2 class="text-2xl text-center lg:text-start lg:text-4xl font-semibold">
Klausimai
          </h2>
          ...
          <div class="space-y-4">
            <details class="w-full rounded-lg border border-secondary">
              <summary class="focus-visible:ri px-4 py-6 focus:outline-none hover:cursor-pointer">
              Ar konsultacijos vyksta ir išvados teikiamos lietuvių kalba?
              </summary>
              <p class="-mt-4 ml-4 px-4 py-6 pt-0 dark:text-gray-400">
              Konsultacijos bei visi pateikiami dokumentai klientams yra lietuvių kalba.
              </p>
            </details>
            <details class="w-full rounded-lg border border-secondary" open="">
              <summary class="focus-visible:ri px-4 py-6 focus:outline-none hover:cursor-pointer">
